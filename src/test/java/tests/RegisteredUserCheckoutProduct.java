...
public class RegisteredUserCheckoutProduct extends TestBase
{
	...
	public void UserCanRegisterSuccssfully()
	{
		...
		registerObject.userRegistration("Sofien", "Rhouma", "midou.sbou3i4@outlook.fr", "12345678");
	...
	public void UserCanCheckoutProduct() throws InterruptedException 
	{
		...
		checkoutObject.RegisteredUserCheckoutProduct("Egypt", "test adres", "123456", "32445566677", "Cairo", productName);
